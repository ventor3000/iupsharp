...
namespace IupSharp
{
    ...
    public static class IupNative
    {
        ...
        // Thread checking — thread safety utils.
        // ------------------------------------------------------------------ //
        internal static int UiThreadId;   // set in Iup.Open()
        public static bool StrictChecks = true;   // let users turn it off in shipping builds
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupUpdate(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupUpdateChildren(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupRedraw(Ihandle ih, int children);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupRefresh(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupRefreshChildren(Ihandle ih);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupSetLanguagePack(Ihandle ih);

        // ---------- Handle tree ------------------------------------------ //

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupDestroy(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupDetach(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupAppend(Ihandle ih, Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupInsert(Ihandle ih, Ihandle refChild, Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupGetChild(Ihandle ih, int pos);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupGetChildPos(Ihandle ih, Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupGetChildCount(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupGetNextChild(Ihandle ih, Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupGetBrother(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupGetParent(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupGetDialog(Ihandle ih);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupReparent(Ihandle ih, Ihandle newParent, Ihandle refChild);

        // ---------- Visibility ------------------------------------------- //

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupPopup(Ihandle ih, int x, int y);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupShow(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupShowXY(Ihandle ih, int x, int y);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupHide(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupMap(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupUnmap(Ihandle ih);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupGetAllAttributes(Ihandle ih, IntPtr[] names, int n);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupCopyAttributes(Ihandle srcIh, Ihandle dstIh);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupSetFocus(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupGetFocus();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupPreviousField(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupNextField(Ihandle ih);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupGetAllNames(IntPtr[] names, int n);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupGetAllDialogs(IntPtr[] names, int n);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupGetAllClasses(IntPtr[] names, int n);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupSaveClassAttributes(Ihandle ih);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupCopyClassAttributes(Ihandle srcIh, Ihandle dstIh);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFill();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupSpace();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupRadio(Ihandle child);

        // IupVbox / IupHbox / IupZbox etc. use C varargs terminated by NULL.
        // Expose the *v (array) variants which are more idiomatic in P/Invoke.

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupVboxv(params Ihandle[] children);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupZboxv(params Ihandle[] children);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupHboxv(params Ihandle[] children);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupNormalizerv(params Ihandle[] ihList);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupCboxv(params Ihandle[] children);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupSbox(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupSplit(Ihandle child1, Ihandle child2);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupScrollBox(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFlatScrollBox(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupGridBoxv(Ihandle[] children);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupMultiBoxv(Ihandle[] children);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupExpander(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupDetachBox(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupBackgroundBox(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFrame(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFlatFrame(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupImage(int width, int height, byte[] pixels);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupImageRGB(int width, int height, byte[] pixels);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupImageRGBA(int width, int height, byte[] pixels);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupSeparator();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupMenuv(Ihandle[] children);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupDropButton(Ihandle dropChild);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFlatSeparator();
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupDialog(Ihandle child);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupUser();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupThread();
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFlatList();
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupTimer();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupClipboard();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupProgressBar();
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFlatTree();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupTabsv(Ihandle[] children);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFlatTabsv(Ihandle[] children);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupTree();
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupAnimatedLabel(Ihandle animation);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupDatePick();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupCalendar();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupColorbar();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupGauge();
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupColorBrowser();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupSpin();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupSpinbox(Ihandle child);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupTextConvertLinColToPos(
            Ihandle ih, int lin, int col, out int pos);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void IupTextConvertPosToLinCol(
            Ihandle ih, int pos, out int lin, out int col);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupConvertXYToPos(Ihandle ih, int x, int y);

        // Tree utilities
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupTreeSetUserId(Ihandle ih, int id, IntPtr userid);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr IupTreeGetUserId(Ihandle ih, int id);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupTreeGetId(Ihandle ih, IntPtr userid);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFileDlg();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupMessageDlg();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupColorDlg();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupFontDlg();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupProgressDlg();

        // IupGetFile — char* buffer, caller-provided
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupGetFile(
            [MarshalAs(UnmanagedType.LPArray)] byte[] arq);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int IupGetColor(
            int x, int y, out byte r, out byte g, out byte b);
        ...
        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupParamBoxv(Ihandle[] paramArray);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupLayoutDialog(Ihandle dialog);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupElementPropertiesDialog(
            Ihandle parent, Ihandle elem);

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupGlobalsDialog();

        [DllImport(Lib, CallingConvention = CallingConvention.Cdecl)]
        public static extern Ihandle IupClassInfoDialog(Ihandle parent);
        ...
        public static int RecordInput(string filename, RecordMode mode)
            => IupRecordInput(filename, (int)mode);

        public static int PlayInput(string filename)
            => IupPlayInput(filename);
        ...
        public static string Load(string filename)
            => PtrToStringUTF8(IupLoad(filename));

        public static string LoadBuffer(string buffer)
            => PtrToStringUTF8(IupLoadBuffer(buffer));
        ...
        public static string GetLanguage()
            => PtrToStringUTF8(IupGetLanguage());
        ...
        public static string GetLanguageString(string name)
            => PtrToStringUTF8(IupGetLanguageString(name));

        public static Ihandle GetDialogChild(Ihandle ih, string name)
            => IupGetDialogChild(ih, name);
        ...
        public static Ihandle SetAttributes(Ihandle ih, string str)
            => IupSetAttributes(ih, str);

        public static string GetAttributes(Ihandle ih)
            => PtrToStringUTF8(IupGetAttributes(ih));
        ...
        public static string GetAttribute(Ihandle ih, string name)
            => PtrToStringUTF8(IupGetAttribute(ih, name));
        ...
        public static int GetIntInt(Ihandle ih, string name, out int i1, out int i2)
            => IupGetIntInt(ih, name, out i1, out i2);

        public static float GetFloat(Ihandle ih, string name)
            => IupGetFloat(ih, name);

        public static double GetDouble(Ihandle ih, string name)
            => IupGetDouble(ih, name);
        ...
        public static string GetAttributeId(Ihandle ih, string name, int id)
            => PtrToStringUTF8(IupGetAttributeId(ih, name, id));

        public static int GetIntId(Ihandle ih, string name, int id)
            => IupGetIntId(ih, name, id);

        public static float GetFloatId(Ihandle ih, string name, int id)
            => IupGetFloatId(ih, name, id);

        public static double GetDoubleId(Ihandle ih, string name, int id)
            => IupGetDoubleId(ih, name, id);
        ...
        public static string GetAttributeId2(Ihandle ih, string name, int lin, int col)
            => PtrToStringUTF8(IupGetAttributeId2(ih, name, lin, col));

        public static int GetIntId2(Ihandle ih, string name, int lin, int col)
            => IupGetIntId2(ih, name, lin, col);

        public static float GetFloatId2(Ihandle ih, string name, int lin, int col)
            => IupGetFloatId2(ih, name, lin, col);

        public static double GetDoubleId2(Ihandle ih, string name, int lin, int col)
            => IupGetDoubleId2(ih, name, lin, col);
        ...
        public static string GetGlobal(string name)
            => PtrToStringUTF8(IupGetGlobal(name));
        ...
        public static Ihandle GetAttributeHandle(Ihandle ih, string name)
            => IupGetAttributeHandle(ih, name);

        public static void SetAttributeHandleId(Ihandle ih, string name, int id, Ihandle ihNamed)
            => IupSetAttributeHandleId(ih, name, id, ihNamed);

        public static Ihandle GetAttributeHandleId(Ihandle ih, string name, int id)
            => IupGetAttributeHandleId(ih, name, id);

        public static void SetAttributeHandleId2(Ihandle ih, string name, int lin, int col, Ihandle ihNamed)
            => IupSetAttributeHandleId2(ih, name, lin, col, ihNamed);

        public static Ihandle GetAttributeHandleId2(Ihandle ih, string name, int lin, int col)
            => IupGetAttributeHandleId2(ih, name, lin, col);

        // --- Class info ---

        public static string GetClassName(Ihandle ih)
            => PtrToStringUTF8(IupGetClassName(ih));

        public static string GetClassType(Ihandle ih)
            => PtrToStringUTF8(IupGetClassType(ih));

        public static int GetClassAttributes(string classname, IntPtr[] names, int n)
            => IupGetClassAttributes(classname, names, n);

        public static int GetClassCallbacks(string classname, IntPtr[] names, int n)
            => IupGetClassCallbacks(classname, names, n);

        public static void SetClassDefaultAttribute(string classname, string name, string value)
            => IupSetClassDefaultAttribute(classname, name, value);

        public static int ClassMatch(Ihandle ih, string classname)
            => IupClassMatch(ih, classname);
        ...
        public static int StringCompare(string str1, string str2, bool caseSensitive, bool lexicographic)
            => IupStringCompare(str1, str2, caseSensitive ? 1 : 0, lexicographic ? 1 : 0);

        public static int SaveImageAsText(Ihandle ih, string filename, string format, string name)
            => IupSaveImageAsText(ih, filename, format, name);

        public static Ihandle ImageGetHandle(string name)
            => IupImageGetHandle(name);
        ...
        public static int MessageAlarm(Ihandle parent, string title, string message, string buttons)
            => IupMessageAlarm(parent, title, message, buttons);

        public static int Alarm(string title, string msg, string b1, string b2, string b3)
            => IupAlarm(title, msg, b1, b2, b3);
